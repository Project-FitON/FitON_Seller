...
class ReviewsScreen extends StatefulWidget {
  ...
  const ReviewsScreen({Key? key, required this.shopId}) : super(key: key);
...
class _ReviewsScreenState extends State<ReviewsScreen> {
  ...
  Future<void> _loadReviews() async {
    try {
      ...
      print('Loading reviews for shop ID: ${widget.shopId}');
      ...
      print('Shop found, fetching reviews...');
      ...
      if (mounted) {
        ...
        print('Number of reviews found: ${reviews.length}');
      ...
      child: Column(
        children: [
          ...
          ...[5, 4, 3, 2, 1].map((rating) {
            ...
            final percentage =
                _reviews.isEmpty ? 0.0 : (count / _reviews.length * 100);
            return Padding(
                        ...
                        CircleAvatar(
                          ...
                          backgroundImage:
                              buyer?['profile_photo'] != null
                                  ? NetworkImage(buyer!['profile_photo'])
                                  : null,
                          child:
                              buyer?['profile_photo'] == null
                                  ? Icon(
